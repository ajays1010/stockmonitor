...
def main():
    ...
    files_ok = all([
        ...
        check_file_exists("sentiment_analyzer.py", "Sentiment analyzer"),
        check_file_exists("sentiment_analysis_service.py", "Sentiment analysis service"),
        check_file_exists("rss_news_fetcher.py", "RSS news fetcher"),
        check_file_exists("ai_news_deduplicator.py", "AI news deduplicator"),
        check_file_exists("news_sentiment_monitor.py", "News sentiment monitor"),
